...
public class Constants {
    //private static final String URL_ROOT = "http://192.168.1.37:81/s_Project/v1/";
    private static final String URL_ROOT = "http://argeosau.xyz/v1/";
    ...
    public static final String URL_LOAD_IMAGE = URL_ROOT+"getImage.php";
}
